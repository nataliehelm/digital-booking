...
public class Product10 {
    ...
    public void Loader(){
        ...
        Product product10 = new Product("Hostel Danny", "A  200 m del centro", 0.0F, 0.0F,"Puedes cancelar más tarde. Aprovecha y consigue un buen precio hoy.", "El Hostel Danny ofrece alojamiento con WiFi gratuita en todas las instalaciones en El Calafate, a 5 km del lago Argentino y a 800 metros del Museo Regional. El establecimiento está a 1,6 km de la estación de autobuses de El Calafate, a 2,2 km de la laguna de Nimez y a 8,8 km de la isla Solitaria. Hay servicio de conserjería, mostrador de información turística y servicio de cambio de divisa.", coordinates2, category2 , location5, "Gobernador Gregores 989", features2, policies, user );
